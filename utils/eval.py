...
def measure_mea(mask_name):
    ...
    return sm, changeable_em, wfm, mae, dice
...
def eval(mask_path='./Dataset/TestDataset',
    ...
    for dataset in [dataset_name]:
        mask_root = os.path.join(mask_path, 'isic2016','ISBI2016_ISIC_Part1_Test_GroundTruth')
        ...
        results = {
            ...
            "dice": np.mean(np.array(dices, dtype=np.float64)),
        }
